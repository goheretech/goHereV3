export const serv = [
    {
        ...
        metaDesc:
            'Hire goHere for full stack development. Our standards of excellence in building your technology project is a competitive advantage. Contact us for your front and back end needs',
        desc:
    ...
    },
    {
        ...
        titleTag:
            'Mobile, Web, AR & VR Application Development Company - goHere',
        metaDesc:
            'Engage your users or target audience with an application from goHere. Custom software and technology solutions engineered for ROI.',
        desc:
    ...
    },
    {
        ...
        metaDesc:
            'Mobile first UI / UX strategies and web content that is responsive to users’ screens will ensure that your content is set up to convert desired actions. AR / VR projects open availability.',
        desc:
    ...
    },
    {
        ...
        metaDesc:
            "Augment Your Reality, go here for engaging user experiences that maintain users' attention and drive them towards your call to actions. ROI focused.",
        desc:
    ...
    },
    {
        ...
        metaDesc:
            'Make your website up to 200% faster with platinum level hosting through the Google Cloud Platform.',
        desc:
    ...
    },
    {
        ...
        metaDesc:
            "Streamline your company for sucess. Google Suite Integration can increase efficiency and productivity in organizations when set up properly. goHere, we speak Google's language.",
        desc:
    ...
    },
    {
        ...
        titleTag:
            'White Labeled Technology Solutions - goHere, Augment Your Reality™',
        metaDesc:
            'As your creative return on investment partner, goHere is flexible in providing customized, white labeled technology solutions for all industries.',
        desc:
    ...
    },
    {
        ...
        titleTag:
            'Get Better Online Results, Conversion Rate Optimization - goHere™',
        metaDesc:
            "Let us audit your company's web and technology presence. Our team will craft strategies to achieve digital presences that produces ROI.",
        desc:
    ...
    },
    {
        ...
        metaDesc:
            'Target your customers in an optimized approach, ensuring brand loyalty is built within your desired demographcis. Augmented Reality lead generation solutions available.',
        desc:
    ...
    },
    {
        ...
        titleTag:
            'Creative Direction & Consulting - goHere, Augment Your Reality',
        metaDesc:
            'Our executive team of management consultants will give your business the creative direction needed to establish brand identity and trust. AR / VR consulting available. Call for details.',
        desc:
    ...
    },
    {
        ...
        metaDesc:
            'The right content strategy helps establish brand awareness, drives conversions, and optimizes for search engine results.',
        desc:
    ...
    },
    {
        ...
        metaDesc:
            'Augment your reality with goHere. Establish brand equity and identity that is optimized for your target audience through emerging technology solutions including Augmented Reality.',
        desc:
    ...
    },
    {
        ...
        metaDesc:
            'Organic, direct traffic to your website or application is worth its weight in gold. We at goHere speak to Google for you. Search is changing towards new channels; voice, visual, and local. Stay ahead of the curve and goHere.',
        desc:
    ...
    },
    {
        ...
        metaDesc:
            'Our PR team are experts in the psychology of selling, business development, and brand management. Let us craft a story that creates the right emotions.',
        desc:
    ...
    },
    {
        ...
        metaDesc:
            'Augmented reality in 2020 can establish brand identity within your target audience. Let our team create the strategy the best aligns with your organization.',
        desc:
    ...
    },
    {
        ...
        metaDesc:
            'Control the public narrative of your company. Tell a story that speaks and works for you. goHere to Augment your reality™.',
        desc:
    ...
    },
    {
        ...
        metaDesc:
            'Utilizing data driven insights and market research, our team of engineers and business professionals have all the tools you need to facilitate any idea, period. We are your ROI partner.',
        desc:
    ...
    },
    {
        ...
        metaDesc:
            'Systems created with UI UX at the forefront will propel your organization forward and help you easily manage tasks, inventory, schedules, projects in one place.',
        desc:
    ...
    },
    {
        ...
        metaDesc:
            'Augment your reality™ with goHere; compile old legacy systems and start developing for the next technological trend: augmented reality and virtual reality.',
        desc:
    ...
    },
    {
        ...
        metaDesc:
            'VR disconnects you from your surroundings. Virtual reality presents business and marketing opportunities. Talk with us about leveraging the power of VR for your orgnization.',
        desc:
    ...
    },
    {
        ...
        metaDesc:
            'Process data wherever possible and act swiftly. Edge computing uses a distributed computer network that enables the internet of things for business and enteprises and will faciliate many VR and AR projects.',
        desc:
    ...
    },
    {
        ...
        metaDesc:
            'Blockchain is revolutionizing the payments and financial world. Organizations will need to react to take advantage of the advantages presented by blockchain tech, goHere and speak to a professional that will guide your company forward into the digital evolution.',
        desc:
    ...
    },
    {
        ...
        metaDesc:
            'AR is the ultimate immersive technology experience that seamlessly blends the digital world with the physical. Augmented reality solutions will propel companies forward throughout this decade.',
        desc:
