export const serv = [
    {
        ...
        mTitle: 'goHere Full Stack Development',
        mDesc:
            'goHere for full stack development. We utilize the latest practices in building your technology project. Contact us for your front and back end needs.',
        desc:
    ...
    },
    {
        ...
        mTitle: 'goHere for Application Development',
        mDesc:
            'goHere for application development that is geared towards conversions and user experiences. Validate your company today with custom applications.',
        desc:
    ...
    },
    {
        ...
        mTitle: 'goHere for Responsive User Interfaces',
        mDesc:
            'Mobile first design strategies and web content that is responsive to users’ screens will ensure that your content is set up to convert. Front end designs that are responsive to any screen.',
        desc:
    ...
    },
    {
        ...
        mTitle: 'Engaging User Experiences - goHere for AR',
        mDesc:
            'goHere for engaging user experiences. Maintain the users’ attention and drive them towards your desired actions.',
        desc:
    ...
    },
    {
        ...
        mTitle: 'goHere - Platinum Level Hosting',
        mDesc:
            'Make your website up to 200% faster with goHere’s utilization of platinum level hosting through the Google Cloud Platform.',
        desc:
    ...
    },
    {
        ...
        ico: 'fab fa-google',
        slug: 'google-suite',
        mTitle: 'goHere to Optimize Your Business’ Google Suite Integration',
        mDesc:
            'Google Suite integration will help you streamline your business for success. goHere speaks Google’s language; we will ensure that our partners are utilizing the full suite to its maximum potential.',
        desc:
    ...
    },
    {
        ...
        mTitle: 'goHere - White Labelled Technology Solutions',
        mDesc:
            'As your creative return on investment partner, goHere is flexible in p[roviding customized technology solutions that can be white labeled to your brand.',
        desc:
    ...
    },
    {
        ...
        mTitle: 'goHere for Conversion Rate Optimization',
        mDesc:
            'Achieve a digital presence that optimizes your company’s conversion rate. We will audit your online presence and identify ',
        desc:
    ...
    },
    {
        ...
        mTitle: 'Lead Generation Experts - goHere - Augment Your Reality',
        mDesc:
            'goHere emphasizes conversion rate optimization to ensure your company is receiving high quality leads. Target your customers in an optimized approach and ensure your brand is building trust with your demographic.',
        desc:
    ...
    },
    {
        ...
        mTitle: 'Creative Direction - goHere for Consulting',
        mDesc:
            'Set your company up for success. Our management consulting team will give your business the creative direction needed to engage audiences and establish brand identity.',
        desc:
    ...
    },
    {
        ...
        mTitle: 'goHere for Quality, Rich Content Strategies',
        mDesc:
            'The right content strategy will help your company generate leads, drive conversions, and optimize search engine results.',
        desc:
    ...
    },
    {
        ...
        mTitle: 'Optimized Digital Marketing - goHere for Brand Equity',
        mDesc:
            'Marketing your business online is a fantastic way to grow your business. Establish a brand identity that sells through goHere’s digital marketing strategy.',
        desc:
    ...
    },
    {
        ...
        mTitle: 'goHere for Search Engine Optimization',
        mDesc:
            'Organic, direct traffic to your website is worth its weight in gold. We at goHere speak to Google for you. Let us increase your brand awareness through SEO.',
        desc:
    ...
    },
    {
        ...
        mTitle: 'goHere for Outstanding PR',
        mDesc:
            'We at goHere are experts in the psychology of selling, business development, and brand identity management. Let us craft a story for your company that sells.',
        desc:
    ...
    },
    {
        ...
        ico: 'fas fa-laptop-code',
        slug: 'brand-identity',
        mTitle: 'goHere to Establish Brand Identity',
        mDesc:
            'Create a brand strategy that appeals to your target audience. Generate more leads and optimize your strategy for growth. goHere for up to date strategies based on market research and trends.',
        desc:
    ...
    },
    {
        ...
        mTitle: 'goHere - Your PR / Reputation Management Partner',
        mDesc:
            'Control the public narrative of your company. Tell a story that sells for you. Go here for public relations and reputation management. ',
        desc:
    ...
    },
    {
        ...
        mTitle: 'goHere for your Go To Market Strategy',
        mDesc:
            'Utilizing data driven insights and market research, goHere for growth strategy, advertising, SEO, resource planning, PR, and web services.',
        desc:
    ...
    },
    {
        ...
        mTitle: 'goHere for Detailed System Auditing',
        mDesc:
            'Systems created with user experience at the forefront will propel your company forward and help you easily manage tasks, inventory, schedules, projects in one easy to use place.',
        desc:
    ...
    },
    {
        ...
        mTitle: 'Impressive Enterprise Resource Planning - goHere',
        mDesc:
            'Compiling old legacy systems into one interface creates order and reduces error for streamlined collaboration and communication. ERPs that maximize efficiency create self-sustaining systems; goHere for more information.',
        desc:
    ...
    },
    {
        ...
        mTitle: 'goHere for Virtual Reality Experiences',
        mDesc:
            'Virtual reality disconnects you from your surroundings. VR presents incredible business and marketing opportunities. Talk with goHere about leveraging the power of virtual reality for your company. ',
        desc:
    ...
    },
    {
        ...
        ico: 'fas fa-hdd',
        slug: 'edge-computing',
        mTitle: 'Edge Computing with goHere',
        mDesc:
            'Process data wherever possible and act swiftly. Edge computing uses a distributed computer network that enables the internet of things for business and enterprises.',
        desc:
    ...
    },
    {
        ...
        section: 'Impress',
        ico: 'fab fa-google',
        slug: 'block-chain-technology',
        mTitle: 'goHere for Blockchain Technology Consulting',
        mDesc:
            'Blockchain is revolutionizing the payments and financial world. Businesses will need to react to take advantage of the advantages presented by blockchain tech, goHere and speak to a professional that will guide your company forward into the digital evolution.',
        desc:
    ...
    },
    {
        ...
        mTitle: 'goHere for AR - Augment Your Reality',
        mDesc:
            'Augmented reality is the ultimate immersive technology experience that seamlessly blends the digital world with the physical. Augmented reality solutions will propel companies forward throughout this decade.',
        desc: '<p>Augment your Reality™. </p>',
    },
];
