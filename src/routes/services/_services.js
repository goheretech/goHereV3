export const serv = [
    {
        ...
        seoImg: 'https://gohere.ghost.io/content/images/size/w1600/2021/02/mr-menus-1.jpg',
    },
    {
    ...
    },
    {
        ...
        metaDesc:
            'Mobile first UI/UX strategies and web content that is responsive to users’ screens will ensure that your content is set up to convert desired actions.',
        desc:
            '<p>Responsive user interface refers to building front end designs that “respond” to the size of the screen a user is viewing a website on. Mobile first design strategy ensures your mobile website converts--which is especially important as phone website views dramatically outpace desktop website views.<br><br>Creating engaging user experiences is all about capturing and maintaining the attention of the user by anticipating their needs--by answering their next question. A user should flow naturally through your website, pulled along by engaging scroll movements, attention grabbing designs, and well placed buttons, forms, and links--every action imperceptibly leading them towards the desired action: conversion.</p>',
        seoImg: 'https://gohere.ghost.io/content/images/size/w1600/2021/02/mr-menus-1.jpg',
    },
    {
        ...
        seoImg: 'https://gohere.ghost.io/content/images/size/w1600/2021/02/cafe-menu-mixed-reality-optimized-3.jpg',
    },
    {
    ...
    },
    {
        ...
        ico: 'fas fa-brush',
        slug: 'mixed-reality',
        titleTag: 'Mixed Reality Consultants - Hololens 2 Developers - goHere®',
        metaDesc:
            'Augment your reality™ with goHere; compile old legacy systems and start developing for the next technological trend: mixed reality and augmented reality ',
        desc:
            '<p>Mixed reality eliminates the need for screens--and as the hardware for this technology advances, we will see screens eliminated. The future applications of MR outpace that of AR because the handsfree, heads up display nature of MR removes the need to leave your physical surroundings by immersing into a screen.</p>',
        seoImg: 'https://gohere.ghost.io/content/images/size/w1600/2021/02/cafe-menu-mixed-reality-optimized-3.jpg',
    },
    {
    ...
    },
    {
        ...
        titleTag:
            'Augmented Reality Developers - goHere® - Augment Your Reality™',
        metaDesc:
        ...
        desc:
            '<p>AR is the ultimate immersive technology experience that seamlessly blends the digital world with the physical. Augmented reality solutions will propel companies forward throughout this decade.</p><p>96% of top AR stakeholders believe glasses based augmented reality will overtake screen based AR applications within the next 3 years--44% of those predict we will see this shift within the next 1-2 years.</p>',
        seoImg: 'https://gohere.ghost.io/content/images/size/w1600/2021/02/mr-tv-1.jpg',
    },
];
